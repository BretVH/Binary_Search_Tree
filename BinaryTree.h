...
struct BTNode {
 ...
 BTNode( T elem, BTNode* left = NULL, BTNode* right = NULL, BTNode* middle = NULL, BTNode* super = NULL ) {
    this->elem = elem;
    this->left = left;
    this->right = right;
    this->middle = middle;
...
class BinaryTree {
 public:
  ...
  BTNode<T>* get_parent( BTNode<T>* node);
  BTNode<T>* get_parent( BTNode<T>* node, BTNode<T>* curr );
